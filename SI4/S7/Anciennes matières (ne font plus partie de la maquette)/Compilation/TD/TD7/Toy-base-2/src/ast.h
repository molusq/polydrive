...
enum node_kind {
    ...
    k_return_statement, k_break_statement, k_try_statement,
    k_throw_statement, k_switch_statement
};
...
// ======================================================================
enum expr_kind {
    assign, uarith, barith, ulogic, blogic, comp, ternary, parenthesis,
    preincr, postincr
};
...
ast_node *make_switch_statement(List, ast_node *);
