 ...
 * generate an automatic response. This is the second version of this class.
 * This time, we generate some random behavior by randomly selecting a phrase
...
public class Responder {
    ...
    /**
     * Build up a list of default responses from which we can pick one if we
    ...
    private void fillResponses() {
        ...
        responses
                .add("That's a known problem with Vista. Windows 7 is much better.");
