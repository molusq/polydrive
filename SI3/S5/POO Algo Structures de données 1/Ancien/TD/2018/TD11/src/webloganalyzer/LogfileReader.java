...
/**
 * A class to read information from a file of web server accesses. Currently,
 * the log file is assumed to contain simply date and time information in the
 * format:
 * 
 * year month day hour minute Log entries are sorted into ascending order of
 * date.
 * 
...
public class LogfileReader implements Iterator<LogEntry> {
    ...
    /**
     * Analyze the next line from the log file and make it available via a
     * LogEntry object.
     * 
     * @return A LogEntry containing the data from the next log line.
     */
    ...
    /**
     * Remove an entry. This operation is not permitted.
     */
    public void remove() {
    ...
    /**
     * @return A string explaining the format of the data in the log file.
     */
    String getFormat() {
        return format;
    }
    ...
    /**
     * Set up a fresh iterator to provide access to the data. This allows a
     * single file of data to be processed more than once.
     */
    void reset() {
