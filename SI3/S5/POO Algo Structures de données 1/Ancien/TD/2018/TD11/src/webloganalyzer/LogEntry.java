...
/**
 * Store the data from a single line of a web-server log file. Individual fields
 * are made available via accessors such as getHour() and getMinute().
 * 
...
public class LogEntry implements Comparable<LogEntry> {
     ...
     * 
     * @param logline
     *            A single line from the log. This should be in the format: year
    ...
    /**
     * Create a string representation of the data. This is not necessarily
     * identical with the text of the original log line.
     * 
    ...
    /**
     * Compare the date/time combination of this log entry with another.
     * 
     * @param otherEntry
     *            The other entry to compare against.
     * @return A negative value if this entry comes before the other. A positive
     *         value if this entry comes after the other. Zero if the entries
     *         are the same.
     */
