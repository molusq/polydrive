...
public class AddressBookDemo {
    ...
    /**
     * Setup an AddressBook with sample data. The address book is passed to a
     * GUI to provide a view of the data.
     */
    public AddressBookDemo() {
        ContactDetails[] sampleDetails = {
                ...
                new ContactDetails("kurt", "08459 650000", "address 6.5"),
                new ContactDetails("chris", "08459 700000", "address 7"),
                new ContactDetails("ruth", "08459 800000", "address 8"), };
        book = new AddressBook();
        Arrays.stream(sampleDetails).forEach(d -> book.addDetails(d));
