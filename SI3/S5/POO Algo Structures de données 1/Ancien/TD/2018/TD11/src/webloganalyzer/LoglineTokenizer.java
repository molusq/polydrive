...
public class LoglineTokenizer {
    ...
    /**
     * Tokenize a log line. Place the integer values from it into an array. The
     * number of tokens on the line must be sufficient to fill the array.
     * 
     * @param logline
     ...
     */
    void tokenize(String logline, int[] dataLine) {
        try {
