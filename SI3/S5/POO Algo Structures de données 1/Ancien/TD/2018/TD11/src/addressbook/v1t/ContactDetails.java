...
public class ContactDetails implements Comparable<ContactDetails> {
    ...
    /**
     * Set up the contact details. All details are trimmed to remove trailing
     * white space.
     * 
     * @param name
     *            The name.
     ...
     * @return true if the argument object is a set of contact details with
     *         matching attributes.
     */
     ...
     * The fields are sorted by name, phone, and address.
     * 
     * @param otherDetails
     *            The details to be compared against.
     * @return a negative integer if this comes before the parameter, zero if
     *         they are equal and a positive integer if this comes after the
     *         second.
     */
    ...
    /**
     * Compute a hashcode using the rules to be found in "Effective Java", by
     * Joshua Bloch.
     * 
