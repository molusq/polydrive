...
/*
Pour la fonction strncmp, on part de la fonction strcmp écrite précédemment en lui 
ajoutant un contrainte sur la longueur (le troisième paramètre):
*/
...
/*
Pour cette fonction, on utilise tolower qui permet de convertir un caractère en 
minuscule (cette fonction est définie dans ctype.h). Pour le reste la fonction est 
identique à la fonction strcmp écrite précédemment:
*/
...
/*
La fonction strspn renvoie la longueur du segment initial de s qui ne contient que 
des caractères présents dans accept.
Pour cela, on parcourt le chaîne s caractère par caractère et on vérifie qu’il se 
trouve bien dans la chaîne accept.
*/
